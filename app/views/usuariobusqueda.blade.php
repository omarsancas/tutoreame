        ...
        <div class="panel panel-default">
            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="home">
                    {{ Form::open(array('route' => 'buscar','class' => 'form-horizontal')) }}
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-default center-block">
                            <div class="panel-body text-center">
                                ...
                                <a href="#" class="h5 margin-none"> {{ $tutor->NOMBRE_TUTOR}}</a>
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                    <a href="{{ URL::to('videollamada')}}" class="btn btn-primary btn-xs pull-right">Conectar</a>
